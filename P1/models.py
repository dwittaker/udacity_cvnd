...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.maxpool1 = nn.MaxPool2d(2,2) #110
        self.conv2 = nn.Conv2d(32, 64, 3) #108
        self.conv2_bn = nn.BatchNorm2d(64)
        self.maxpool2 = nn.MaxPool2d(2,2) #54
        
        self.conv3 = nn.Conv2d(64, 128, 3) #52
        self.conv3_bn = nn.BatchNorm2d(128)
        self.maxpool3 = nn.MaxPool2d(2,2) #26
        
        self.fc1 = nn.Linear(128*26*26, 408)
        self.drop1 = nn.Dropout2d(p=0.2)
        self.fc2 = nn.Linear(408, 136)
